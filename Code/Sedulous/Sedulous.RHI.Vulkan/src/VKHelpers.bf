...
{
	/// <summary>
	/// Creates a valid API version uint32.
	/// </summary>
	...
	public static uint32 GetBinding(LayoutElementDescription element)
	{
		...
		case ResourceType.ConstantBuffer:
			return element.Slot + SPIRVBindingOffsets.ConstantBufferOffset;
		case ResourceType.StructuredBufferReadWrite,
			ResourceType.TextureReadWrite:
			return element.Slot + SPIRVBindingOffsets.StorageAndTextureBufferOffset;
		case ResourceType.Sampler:
			return element.Slot + SPIRVBindingOffsets.SamplerOffset;
		case ResourceType.StructuredBuffer,
			ResourceType.Texture,
			ResourceType.AccelerationStructure:
			return element.Slot + SPIRVBindingOffsets.TextureOffset;
		default:
			return 0;
		}
	}

...
public abstract class ResourceFactory
{
	...
	/// <summary>
	/// Creates a <see cref="T:Sedulous.RHI.MeshShader.MeshShaderPipelineState" /> instance.
	/// </summary>
	/// <param name="description">The mesh shader pipeline state description.</param>
	/// <returns>The new pipeline state.</returns>
	public MeshShaderPipelineState CreateMeshShaderPipeline(in MeshShaderPipelineDescription description)
	{
		GraphicsContext.ValidationLayer?.CreateMeshShaderPipelineValidation(description);
		return CreateMeshShaderPipelineInternal(description);
	}
	...
	/// <returns>The new pipeline state.</returns>
	[Inline]
	protected abstract MeshShaderPipelineState CreateMeshShaderPipelineInternal(in MeshShaderPipelineDescription description);
	...
	public abstract void DestroyGraphicsPipeline(ref GraphicsPipelineState pipeline);

	public abstract void DestroyComputePipeline(ref ComputePipelineState pipeline);

	public abstract void DestroyRaytracingPipeline(ref RaytracingPipelineState pipeline);

	public abstract void DestroyMeshShaderPipeline(ref MeshShaderPipelineState pipeline);
	...
	public abstract void DestroySampler(ref SamplerState sampler);

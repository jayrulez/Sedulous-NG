...
public class VKBuffer : Sedulous.RHI.Buffer
{
	...
	public void SetData(VkCommandBuffer commandBuffer, void* source, uint32 sourceSizeInBytes, uint32 destinationOffsetInBytes = 0)
	{
		...
		// Use BOTTOM_OF_PIPE as destination stage since this may run on a transfer-only queue.
		...
		VulkanNative.vkCmdPipelineBarrier(commandBuffer, VkPipelineStageFlags.VK_PIPELINE_STAGE_TRANSFER_BIT, VkPipelineStageFlags.VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT, VkDependencyFlags.None, 0, null, 1, &barrier, 0, null);
	}

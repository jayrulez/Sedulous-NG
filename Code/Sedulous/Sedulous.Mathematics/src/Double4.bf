...
[CRepr]public struct Double4 : IEquatable<Double4>
{
    ...
    /// </summary>
    public static readonly int32 SizeInBytes = sizeof(Double4);
    ...
    /// </summary>
    public static readonly Double4 UnitX = .(1.0, 0.0, 0.0, 0.0);

    /// <summary>
    /// The Y unit <see cref="Double4"/> (0, 1, 0, 0).
    /// </summary>
    public static readonly Double4 UnitY = .(0.0, 1.0, 0.0, 0.0);

    /// <summary>
    /// The Z unit <see cref="Double4"/> (0, 0, 1, 0).
    /// </summary>
    public static readonly Double4 UnitZ = .(0.0, 0.0, 1.0, 0.0);

    /// <summary>
    /// The W unit <see cref="Double4"/> (0, 0, 0, 1).
    /// </summary>
    public static readonly Double4 UnitW = .(0.0, 0.0, 0.0, 1.0);

    /// <summary>
    /// A <see cref="Double4"/> with all of its components set to one.
    /// </summary>
    public static readonly Double4 One = .(1.0, 1.0, 1.0, 1.0);
    ...
    /// <param name="w">Initial value for the W component of the vector.</param>
    public this(Double3 value, double w)
    {
        X = value.X;
        Y = value.Y;
        Z = value.Z;
    ...
    /// <param name="z">Initial value for the Z component of the vector.</param>
    /// <param name="w">Initial value for the W component of the vector.</param>
    public this(Double2 value, double z, double w)
    {
        X = value.X;
        Y = value.Y;
        Z = z;
    ...
    public double this[int32 index]
    {
        get
        {
			switch (index)
			{
			    ...
			    case 3: return W;
			    default:
			        Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}: Indices for Double4 run from 0 to 3, inclusive.");
			}
        ...
        set mut
        {
            switch (index)
            {
                ...
                default: Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}:Indices for Double4 run from 0 to 3, inclusive.");
            }
        }
    }
    ...
    [Inline]
    public static void Add(Double4 left, Double4 right, out Double4 result)
    {
        result = Double4(left.X + right.X, left.Y + right.Y, left.Z + right.Z, left.W + right.W);
    }
    ...
    [Inline]
    public static void Subtract(Double4 left, Double4 right, out Double4 result)
    {
        result = Double4(left.X - right.X, left.Y - right.Y, left.Z - right.Z, left.W - right.W);
    }
    ...
    [Inline]
    public static void Multiply(Double4 value, double scale, out Double4 result)
    {
        result = Double4(value.X * scale, value.Y * scale, value.Z * scale, value.W * scale);
    }
    ...
    {
        return Double4(value.X * scale, value.Y * scale, value.Z * scale, value.W * scale);
    }
    ...
    [Inline]
    public static void Modulate(Double4 left, Double4 right, out Double4 result)
    {
        result = Double4(left.X * right.X, left.Y * right.Y, left.Z * right.Z, left.W * right.W);
    }
    ...
    /// <param name="result">When the method completes, contains the scaled vector.</param>
    [Inline]
    public static void Divide(Double4 value, double scale, out Double4 result)
    {
        result = Double4(value.X / scale, value.Y / scale, value.Z / scale, value.W / scale);
    }
    ...
    [Inline]
    public static void Demodulate(Double4 left, Double4 right, out Double4 result)
    {
        result = Double4(left.X / right.X, left.Y / right.Y, left.Z / right.Z, left.W / right.W);
    }
    ...
    [Inline]
    public static void Negate(Double4 value, out Double4 result)
    {
        result = Double4(-value.X, -value.Y, -value.Z, -value.W);
    }
    ...
    {
        return Double4(-value.X, -value.Y, -value.Z, -value.W);
    }
    ...
    public static void Barycentric(Double4 value1, Double4 value2, Double4 value3, double amount1, double amount2, out Double4 result)
    {
        result = Double4(value1.X + (amount1 * (value2.X - value1.X)) + (amount2 * (value3.X - value1.X)),
    ...
    public static void Clamp(Double4 value, Double4 min, Double4 max, out Double4 result)
    {
        double x = value.X;
        x = (x > max.X) ? max.X : x;
        x = (x < min.X) ? min.X : x;
    ...
    /// <remarks>
    /// <see cref="Double4.DistanceSquared(Double4, Double4, out double)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    public static void Distance(Double4 value1, Double4 value2, out double result)
    {
    ...
    /// </remarks>
    public static void DistanceSquared(Double4 value1, Double4 value2, out double result)
    {
        double x = value1.X - value2.X;
        double y = value1.Y - value2.Y;
        double z = value1.Z - value2.Z;
    ...
    [Inline]
    public static void Dot(Double4 left, Double4 right, out double result)
    {
    ...
    [Inline]
    public static void Normalize(Double4 value, out Double4 result)
    {
        Double4 temp = value;
        result = temp;
        result.Normalize();
    ...
    /// </remarks>
    public static void Lerp(Double4 start, Double4 end, double amount, out Double4 result)
    {
    ...
    public static void SmoothStep(Double4 start, Double4 end, double amount, out Double4 result)
    {
		var amount;
    ...
    public static void Hermite(Double4 value1, Double4 tangent1, Double4 value2, Double4 tangent2, double amount, out Double4 result)
    {
        ...
        result = Double4((value1.X * part1) + (value2.X * part2) + (tangent1.X * part3) + (tangent2.X * part4),
    ...
    public static void CatmullRom(Double4 value1, Double4 value2, Double4 value3, Double4 value4, double amount, out Double4 result)
    {
        double squared = amount * amount;
        double cubed = amount * squared;
    ...
    [Inline]
    public static void Max(Double4 left, Double4 right, out Double4 result)
    {
    ...
    [Inline]
    public static void Min(Double4 left, Double4 right, out Double4 result)
    {
        result.X = (left.X < right.X) ? left.X : right.X;
        result.Y = (left.Y < right.Y) ? left.Y : right.Y;
        result.Z = (left.Z < right.Z) ? left.Z : right.Z;
    ...
    public static void Transform(Double4 vector, Quaternion rotation, out Double4 result)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
    public static void Transform(Double4[] source, Quaternion rotation, Double4[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    /// <param name="result">When the method completes, contains the transformed <see cref="Double4"/>.</param>
    public static void Transform(Double4 vector, Matrix transform, out Double4 result)
    {
        result = Double4(
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
    public static void Transform(Double4[] source, Matrix transform, Double4[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    {
        return Double4(numerator / value.X, numerator / value.Y, numerator / value.Z, numerator / value.W);
    }
    ...
    {
        return Double4(value.X / by.X, value.Y / by.Y, value.Z / by.Z, value.W / by.W);
    }

...
public struct SamplerStateDescription : IEquatable<SamplerStateDescription>
{
	...
	{
		return (int)(((((((((((((((((uint32)((int32)Filter * 397) ^ (uint32)AddressU) * 397) ^ (uint32)AddressV) * 397) ^ (uint32)AddressW) * 397) ^ (uint32)MinLOD.GetHashCode()) * 397) ^ (uint32)MaxLOD.GetHashCode()) * 397) ^ (uint32)MipLODBias.GetHashCode()) * 397) ^ MaxAnisotropy) * 397) ^ (uint32)ComparisonFunc) * 397) ^ (int)BorderColor;
	}

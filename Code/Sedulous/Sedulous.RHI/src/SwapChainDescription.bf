...
public struct SwapChainDescription : IEquatable<SwapChainDescription>
{
	...
	{
		return (int)(((((((((((((((((uint32)(SurfaceInfo.GetHashCode() * 397) ^ Width) * 397) ^ Height) * 397) ^ RefreshRate) * 397) ^ (uint32)ColorTargetFormat) * 397) ^ (uint32)ColorTargetFlags) * 397) ^ (uint32)DepthStencilTargetFormat) * 397) ^ (uint32)DepthStencilTargetFlags) * 397) ^ (uint32)SampleCount) * 397) ^ IsWindowed.GetHashCode();
	}

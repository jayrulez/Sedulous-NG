...
[CRepr]public struct ColorBGRA : IEquatable<ColorBGRA>
{
    ...
    public uint8 this[int32 index]
    {
        get
        {
			switch (index)
			{
			    ...
			    case 3: return A;
			    default:
			        Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}: Indices for ColorBGRA run from 0 to 3, inclusive.");
			}
        ...
        set mut
        {
            switch (index)
            {
                ...
                default: Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}:Indices for ColorBGRA run from 0 to 3, inclusive.");
            }
        }
    }
    ...
    public static ColorBGRA FromBgra(int32 color)
    {
        return ColorBGRA(color);
    }
    ...
    /// <returns>A color.</returns>
    public static ColorBGRA FromRgba(int32 color)
    {
        return ColorBGRA((uint8)(color & 255), (uint8)((color >> 8) & 255), (uint8)((color >> 16) & 255), (uint8)((color >> 24) & 255));
    }
    ...
    {
        return FromRgba(unchecked((int32)color));
    }
    ...
    public static void Add(ColorBGRA left, ColorBGRA right, out ColorBGRA result)
    {
    ...
    {
        return ColorBGRA((uint8)(left.R + right.R), (uint8)(left.G + right.G), (uint8)(left.B + right.B), (uint8)(left.A + right.A));
    }
    ...
    public static void Subtract(ColorBGRA left, ColorBGRA right, out ColorBGRA result)
    {
        result.A = (uint8)(left.A - right.A);
        result.R = (uint8)(left.R - right.R);
        result.G = (uint8)(left.G - right.G);
    ...
    public static void Modulate(ColorBGRA left, ColorBGRA right, out ColorBGRA result)
    {
    ...
    {
        return ColorBGRA((uint8)((left.R * right.R) / 255), (uint8)((left.G * right.G) / 255), (uint8)((left.B * right.B) / 255), (uint8)((left.A * right.A) / 255));
    }
    ...
    public static void Scale(ColorBGRA value, float scale, out ColorBGRA result)
    {
    ...
    {
        return ColorBGRA((uint8)(value.R * scale), (uint8)(value.G * scale), (uint8)(value.B * scale), (uint8)(value.A * scale));
    }
    ...
    public static void Negate(ColorBGRA value, out ColorBGRA result)
    {
    ...
    {
        return ColorBGRA((uint8)(255 - value.R), (uint8)(255 - value.G), (uint8)(255 - value.B), (uint8)(255 - value.A));
    }
    ...
    public static void Clamp(ColorBGRA value, ColorBGRA min, ColorBGRA max, out ColorBGRA result)
    {
        uint8 alpha = value.A;
        ...
        result = ColorBGRA(red, green, blue, alpha);
    }
    ...
    /// </remarks>
    public static void Lerp(ColorBGRA start, ColorBGRA end, float amount, out ColorBGRA result)
    {
    ...
    public static void SmoothStep(ColorBGRA start, ColorBGRA end, float amount, out ColorBGRA result)
    {
		var amount;
    ...
    public static void Max(ColorBGRA left, ColorBGRA right, out ColorBGRA result)
    {
    ...
    public static void Min(ColorBGRA left, ColorBGRA right, out ColorBGRA result)
    {
        result.A = (left.A < right.A) ? left.A : right.A;
        result.R = (left.R < right.R) ? left.R : right.R;
        result.G = (left.G < right.G) ? left.G : right.G;
    ...
    public static void AdjustContrast(ColorBGRA value, float contrast, out ColorBGRA result)
    {
        result.A = value.A;
    ...
    /// <param name="result">When the method completes, contains the adjusted color.</param>
    public static void AdjustSaturation(ColorBGRA value, float saturation, out ColorBGRA result)
    {
    ...
    public static ColorBGRA operator -(ColorBGRA value)
    {
        return ColorBGRA(-value.R, -value.G, -value.B, -value.A);
    }
    ...
    public static ColorBGRA operator *(ColorBGRA left, ColorBGRA right)
    {
        return ColorBGRA((uint8)(left.R * right.R / 255.0f), (uint8)(left.G * right.G / 255.0f), (uint8)(left.B * right.B / 255.0f), (uint8)(left.A * right.A / 255.0f));
    }
    ...
    {
        return Color4(value.R / 255.0f, value.G / 255.0f, value.B / 255.0f, value.A / 255.0f);
    }
    ...
    {
        return ColorBGRA(value.X / 255.0f, value.Y / 255.0f, value.Z / 255.0f, 1.0f);
    }
    ...
    {
        return ColorBGRA(value.R, value.G, value.B, 1.0f);
    }
    ...
    {
        return ColorBGRA(value.X, value.Y, value.Z, value.W);
    }
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="ColorBGRA"/> to <see cref="int32"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>
    /// The result of the conversion.
    /// </returns>
    public static explicit operator int32(ColorBGRA value)
    {
        return value.ToBgra();
    }

    /// <summary>
    /// Performs an explicit conversion from <see cref="int32"/> to <see cref="ColorBGRA"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>
    /// The result of the conversion.
    /// </returns>
    public static explicit operator ColorBGRA(int32 value)
    {
    ...
    public void Deconstruct(out uint8 r, out uint8 g, out uint8 b, out uint8 a)
    {
        r = R;
        g = G;
        b = B;

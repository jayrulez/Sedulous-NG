...
public struct TextureDescription : IEquatable<TextureDescription>
{
	...
	private static TextureDescription DefaultValues => TextureDescription
		{
	...
	{
		return (int)(((((((((((((((((((((uint32)((int)Type * 397) ^ (uint32)Format) * 397) ^ Width) * 397) ^ Height) * 397) ^ Depth) * 397) ^ ArraySize) * 397) ^ Faces) * 397) ^ MipLevels) * 397) ^ (uint32)Flags) * 397) ^ (uint32)Usage) * 397) ^ (uint32)Usage) * 397) ^ (int)CpuAccess;
	}

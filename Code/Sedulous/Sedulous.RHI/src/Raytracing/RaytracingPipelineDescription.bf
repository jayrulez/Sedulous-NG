...
public struct RaytracingPipelineDescription : IEquatable<RaytracingPipelineDescription>
{
	...
	{
		return (int)((((((uint32)(((((Shaders.GetHashCode() * 397) ^ ResourceLayouts.GetHashCode()) * 397) ^ HitGroups.GetHashCode()) * 397) ^ MaxTraceRecursionDepth) * 397) ^ MaxPayloadSizeInBytes) * 397) ^ MaxAttributeSizeInBytes);
	}

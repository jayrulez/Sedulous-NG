...
namespace Sedulous.Platform.Core.Input
{
    ...
    public delegate void MouseButtonEventHandler(Window window, MouseDevice device, MouseButton button);
    ...
    public abstract class MouseDevice : InputDevice<MouseButton>
    {
        ...
        public abstract void WarpToWindow(Window window, int32 x, int32 y);

        /// <summary>
        /// Sets the mouse cursor's position to the center of the specified window.
        /// </summary>
        /// <param name="window">The window within which to place the mouse cursor.</param>
        public abstract void WarpToWindowCenter(Window window);
        ...
        /// </summary>
        public readonly EventAccessor<MouseButtonEventHandler> ButtonPressed {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when a mouse button is released.
        /// </summary>
        public readonly EventAccessor<MouseButtonEventHandler> ButtonReleased {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when a mouse button is clicked.
        /// </summary>
        public readonly EventAccessor<MouseButtonEventHandler> Click {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when a mouse button is double clicked.
        /// </summary>
        public readonly EventAccessor<MouseButtonEventHandler> DoubleClick {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when the mouse is moved.
        /// </summary>
        public readonly EventAccessor<MouseMoveEventHandler> Moved {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when the mouse wheel is scrolled.
        /// </summary>
        public readonly EventAccessor<MouseWheelEventHandler> WheelScrolled {get;} = new .() ~ delete _;
        ...
        protected virtual void OnButtonPressed(Window window, MouseButton button) =>
        ...
        protected virtual void OnButtonReleased(Window window, MouseButton button) =>
        ...
        protected virtual void OnClick(Window window, MouseButton button) =>
        ...
        /// <param name="window">The window in which the input event took place.</param>
        /// <param name="button">The mouse button that was clicked.</param>
        protected virtual void OnDoubleClick(Window window, MouseButton button) =>

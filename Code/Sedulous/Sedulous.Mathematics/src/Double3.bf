...
/// </summary>
[CRepr]public struct Double3 : IEquatable<Double3>
{
    /// <summary>
    /// The size of the <see cref="Double3"/> type, in bytes.
    /// </summary>
    public static readonly int32 SizeInBytes = sizeof(Double3);
    ...
    /// </summary>
    public static readonly Double3 UnitX = .(1.0, 0.0, 0.0);

    /// <summary>
    /// The Y unit <see cref="Double3"/> (0, 1, 0).
    /// </summary>
    public static readonly Double3 UnitY = .(0.0, 1.0, 0.0);

    /// <summary>
    /// The Z unit <see cref="Double3"/> (0, 0, 1).
    /// </summary>
    public static readonly Double3 UnitZ = .(0.0, 0.0, 1.0);

    /// <summary>
    /// A <see cref="Double3"/> with all of its components set to one.
    /// </summary>
    public static readonly Double3 One = .(1.0, 1.0, 1.0);
    ...
    /// <param name="z">Initial value for the Z component of the vector.</param>
    public this(Double2 value, double z)
    {
        X = value.X;
        Y = value.Y;
        Z = z;
    ...
    public double this[int32 index]
    {
        get
        {
			switch (index)
			{
			    ...
			    case 2: return Z;
			    default:
			        Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}: Indices for Double3 run from 0 to 2, inclusive.");
			}
        ...
        set mut
        {
            switch (index)
            {
                ...
                default: Runtime.FatalError(scope $"ArgumentOutOfRangeException - {nameof(index)}:Indices for Double3 run from 0 to 2, inclusive.");
            }
        }
    }
    ...
    public void Pow(double exponent) mut
    {
    ...
    [Inline]
    public static void Add(Double3 left, Double3 right, out Double3 result)
    {
        result = Double3(left.X + right.X, left.Y + right.Y, left.Z + right.Z);
    }
    ...
    [Inline]
    public static void Subtract(Double3 left, Double3 right, out Double3 result)
    {
        result = Double3(left.X - right.X, left.Y - right.Y, left.Z - right.Z);
    }
    ...
    [Inline]
    public static void Multiply(Double3 value, double scale, out Double3 result)
    {
        result = Double3(value.X * scale, value.Y * scale, value.Z * scale);
    }
    ...
    [Inline]
    public static void Modulate(Double3 left, Double3 right, out Double3 result)
    {
        result = Double3(left.X * right.X, left.Y * right.Y, left.Z * right.Z);
    }
    ...
    /// <param name="result">When the method completes, contains the scaled vector.</param>
    [Inline]
    public static void Divide(Double3 value, double scale, out Double3 result)
    {
        result = Double3(value.X / scale, value.Y / scale, value.Z / scale);
    }
    ...
    [Inline]
    public static void Demodulate(Double3 left, Double3 right, out Double3 result)
    {
        result = Double3(left.X / right.X, left.Y / right.Y, left.Z / right.Z);
    }
    ...
    [Inline]
    public static void Negate(Double3 value, out Double3 result)
    {
        result = Double3(-value.X, -value.Y, -value.Z);
    }
    ...
    /// <summary>
    /// Returns a <see cref="Sedulous.Mathematics.Double3"/> containing the 3D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 3D triangle.
    /// </summary>
    /// <param name="value1">A <see cref="Sedulous.Mathematics.Double3"/> containing the 3D Cartesian coordinates of vertex 1 of the triangle.</param>
    /// <param name="value2">A <see cref="Sedulous.Mathematics.Double3"/> containing the 3D Cartesian coordinates of vertex 2 of the triangle.</param>
    /// <param name="value3">A <see cref="Sedulous.Mathematics.Double3"/> containing the 3D Cartesian coordinates of vertex 3 of the triangle.</param>
    /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
    /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
    /// <param name="result">When the method completes, contains the 3D Cartesian coordinates of the specified point.</param>
    public static void Barycentric(Double3 value1, Double3 value2, Double3 value3, double amount1, double amount2, out Double3 result)
    {
        result = Double3(value1.X + (amount1 * (value2.X - value1.X)) + (amount2 * (value3.X - value1.X)),
    ...
    public static void Clamp(Double3 value, Double3 min, Double3 max, out Double3 result)
    {
        double x = value.X;
        x = (x > max.X) ? max.X : x;
        x = (x < min.X) ? min.X : x;
    ...
    public static void Cross(Double3 left, Double3 right, out Double3 result)
    {
        result = Double3(
    ...
    /// <remarks>
    /// <see cref="DistanceSquared(Double3, Double3, out double)"/> may be preferred when only the relative distance is needed
    /// and speed is of the essence.
    /// </remarks>
    public static void Distance(Double3 value1, Double3 value2, out double result)
    {
    ...
    /// </remarks>
    public static void DistanceSquared(Double3 value1, Double3 value2, out double result)
    {
        double x = value1.X - value2.X;
        double y = value1.Y - value2.Y;
        double z = value1.Z - value2.Z;
    ...
    [Inline]
    public static void Dot(Double3 left, Double3 right, out double result)
    {
    ...
    [Inline]
    public static void Normalize(Double3 value, out Double3 result)
    {
        result = value;
        result.Normalize();
    }
    ...
    /// </remarks>
    public static void Lerp(Double3 start, Double3 end, double amount, out Double3 result)
    {
    ...
    public static void SmoothStep(Double3 start, Double3 end, double amount, out Double3 result)
    {
		var amount;
    ...
    public static void Hermite(Double3 value1, Double3 tangent1, Double3 value2, Double3 tangent2, double amount, out Double3 result)
    {
    ...
    public static void CatmullRom(Double3 value1, Double3 value2, Double3 value3, Double3 value4, double amount, out Double3 result)
    {
        double squared = amount * amount;
        double cubed = amount * squared;
    ...
    [Inline]
    public static void Max(Double3 left, Double3 right, out Double3 result)
    {
    ...
    [Inline]
    public static void Min(Double3 left, Double3 right, out Double3 result)
    {
        result.X = (left.X < right.X) ? left.X : right.X;
        result.Y = (left.Y < right.Y) ? left.Y : right.Y;
        result.Z = (left.Z < right.Z) ? left.Z : right.Z;
    ...
    public static void Project(Double3 vector, double x, double y, double width, double height, double minZ, double maxZ, Matrix worldViewProjection, out Double3 result)
    {
        TransformCoordinate(vector, worldViewProjection, var v);

        result = Double3(((1.0 + v.X) * 0.5f * width) + x, ((1.0 - v.Y) * 0.5f * height) + y, (v.Z * (maxZ - minZ)) + minZ);
    }
    ...
    public static void Unproject(Double3 vector, double x, double y, double width, double height, double minZ, double maxZ, Matrix worldViewProjection, out Double3 result)
    {
        Double3 v = Double3();
    ...
    public static void Reflect(Double3 vector, Double3 normal, out Double3 result)
    {
    ...
    public static void Transform(Double3 vector, Quaternion rotation, out Double3 result)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
    public static void Transform(Double3[] source, Quaternion rotation, Double3[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    /// <param name="result">When the method completes, contains the transformed <see cref="Double4"/>.</param>
    public static void Transform(Double3 vector, Matrix transform, out Double4 result)
    {
        result = Double4(
    ...
    public static void Transform(Double3 vector, Matrix transform, out Double3 result)
    {
        result = Double3(
            (vector.X * transform.M11) + (vector.Y * transform.M21) + (vector.Z * transform.M31) + transform.M41,
            (vector.X * transform.M12) + (vector.Y * transform.M22) + (vector.Z * transform.M32) + transform.M42,
    ...
    /// <returns>The transformed <see cref="Sedulous.Mathematics.Double4"/>.</returns>
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
    public static void Transform(Double3[] source, Matrix transform, Double4[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    /// </remarks>
    public static void TransformCoordinate(Double3 coordinate, Matrix transform, out Double3 result)
    {
    ...
    /// with coordinates as the w component can safely be ignored.
    /// </remarks>
    public static void TransformCoordinate(Double3[] source, Matrix transform, Double3[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    /// </remarks>
    public static void TransformNormal(Double3 normal, Matrix transform, out Double3 result)
    {
        result = Double3(
    ...
    /// rather than location because normal vectors should not be translated.
    /// </remarks>
    public static void TransformNormal(Double3[] source, Matrix transform, Double3[] destination)
    {
        if(source== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(source)}");
        if(destination== null) Runtime.FatalError(scope $"ArgumentNullException - {nameof(destination)}");
        if (destination.Count< source.Count)
    ...
    public static void RotationYawPitchRoll(Quaternion quaternion, out Double3 yawPitchRoll)
    {
        Vector3 yawPitchRollV;
        Quaternion.RotationYawPitchRoll(quaternion, out yawPitchRollV.X, out yawPitchRollV.Y, out yawPitchRollV.Z);
    ...
    {
        return Double3(numerator / value.X, numerator / value.Y, numerator / value.Z);
    }
    ...
    {
        return Double3(value.X / by.X, value.Y / by.Y, value.Z / by.Z);
    }
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="Sedulous.Mathematics.Double3"/> to <see cref="Sedulous.Mathematics.Vector3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Sedulous.Mathematics.Vector3"/> to <see cref="Sedulous.Mathematics.Double3"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="Sedulous.Mathematics.Double3"/> to <see cref="Sedulous.Mathematics.Double2"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="Sedulous.Mathematics.Double3"/> to <see cref="Sedulous.Mathematics.Double4"/>.
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>The result of the conversion.</returns>
    public static explicit operator Double4(Double3 value)
    {
        return Double4(value, 0.0);
    }

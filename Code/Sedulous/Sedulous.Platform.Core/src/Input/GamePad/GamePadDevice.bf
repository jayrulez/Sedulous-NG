...
namespace Sedulous.Platform.Core.Input
{
    ...
    public abstract class GamePadDevice : InputDevice<GamePadButton>
    {
        ...
        /// </summary>
        public readonly EventAccessor<GamePadButtonPressedEventHandler> ButtonPressed {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when one of the game pad's buttons is released.
        /// </summary>
        public readonly EventAccessor<GamePadButtonReleasedEventHandler> ButtonReleased {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when the value of one of the game pad's axes changes.
        /// </summary>
        public readonly EventAccessor<GamePadAxisEventHandler> AxisChanged {get;} = new .() ~ delete _;
        ...
        /// </summary>
        public readonly EventAccessor<GamePadAxisPressedEventHandler> AxisPressed {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when one of the game pad's axes leaves hte "pressed" state, as determined by
        /// the value of the <see cref="AxisDownThreshold"/> property.
        /// </summary>
        public readonly EventAccessor<GamePadAxisReleasedEventHandler> AxisReleased {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when the value of the game pad's left joystick vector changes.
        /// </summary>
        public readonly EventAccessor<GamePadAxisVectorEventHandler> LeftJoystickVectorChanged {get;} = new .() ~ delete _;

        /// <summary>
        /// Occurs when the value of the game pad's right joystick vector changes.
        /// </summary>
        public readonly EventAccessor<GamePadAxisVectorEventHandler> RightJoystickVectorChanged {get;} = new .() ~ delete _;

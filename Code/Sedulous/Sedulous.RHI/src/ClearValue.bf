...
public struct ClearValue
{
	...
	/// </summary>
	public static ClearValue None => ClearValue
		{
	...
	public static ClearValue Default => ClearValue
		{
			Flags = ClearFlags.All,
			ColorValues = .(Color.CornflowerBlue.ToVector4()),
			Depth = 1f,
			Stencil = 0
		};

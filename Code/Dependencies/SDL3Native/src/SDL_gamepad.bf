...
[CRepr] public struct SDL_GamepadBinding
{
	...
	[CRepr, Union] public struct Input
	{
		public int32 button;

		[CRepr] public struct Axis
		{
			public int32 axis;
			public int32 axis_min;
			public int32 axis_max;
		}
		public using public Axis axis;

		[CRepr] public struct HAT
		{
			public int32 hat;
			public int32 hat_mask;
		}
		public using public HAT hat;

	}
	public using public Input input;

	public SDL_GamepadBindingType output_type;
	[CRepr, Union] public struct Output
	{
	...
	public using public Output output;
}

...
public struct RasterizerStateDescription : IEquatable<RasterizerStateDescription>
{
	...
	{
		return (int)(((((((((((((((uint32)((int32)FillMode * 397) ^ (uint32)CullMode) * 397) ^ ((!FrontCounterClockwise) ? 1 : 0)) * 397) ^ (uint32)DepthBias) * 397) ^ (uint32)DepthBiasClamp.GetHashCode()) * 397) ^ (uint32)SlopeScaledDepthBias.GetHashCode()) * 397) ^ (uint32)DepthClipEnable.GetHashCode()) * 397) ^ (uint32)ScissorEnable.GetHashCode()) * 397) ^ AntialiasedLineEnable.GetHashCode();
	}

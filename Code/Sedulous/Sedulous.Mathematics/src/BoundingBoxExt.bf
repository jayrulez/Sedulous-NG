...
[CRepr]public struct BoundingBoxExt : IEquatable<BoundingBoxExt>
{
    ...
    /// </summary>
    public static readonly BoundingBoxExt Empty = .(BoundingBox.Empty);
    ...
    public void Transform(Matrix world) mut
    {
		var world;
        ...
        Vector3.TransformCoordinate(center, world, out Center);
        ...
        Vector3.TransformNormal(extent, world, out Extent);
    }
    ...
    [Inline]
    public static void Merge(BoundingBoxExt value1, BoundingBoxExt value2, out BoundingBoxExt result)
    {
    ...
    {
		int hash = 17;
		hash = HashCode.Mix(hash, Center.GetHashCode());
		hash = HashCode.Mix(hash, Extent.GetHashCode());
        return hash;
    }
    ...
    {
        return BoundingBox(bbExt.Minimum, bbExt.Maximum);
    }
    ...
    {
        return BoundingBoxExt(boundingBox);
    }
}

...
namespace Sedulous.Platform.Core.Input
{
	...
	public abstract class KeyboardDevice : InputDevice<Scancode>
	{
		...
		/// </summary>
		/// <param name="sb">The <see cref="String"/> to populate with text input data.</param>
		...
		/// </summary>
		public readonly EventAccessor<KeyboardButtonEventHandler> ButtonPressed { get; } = new .() ~ delete _;

		/// <summary>
		/// Occurs when a button is released.
		/// </summary>
		public readonly EventAccessor<KeyboardButtonEventHandler> ButtonReleased { get; } = new .() ~ delete _;
		...
		/// <remarks>Platforms may send multiple key press events while a key is held down. Any such 
		/// event after the first is marked as a "repeat" event and should be handled accordingly.</remarks>
		public readonly EventAccessor<KeyPressedEventHandler> KeyPressed { get; } = new .() ~ delete _;

		/// <summary>
		/// Occurs when a key is released.
		/// </summary>
		public readonly EventAccessor<KeyReleasedEventHandler> KeyReleased { get; } = new .() ~ delete _;

		/// <summary>
		/// Occurs when text input is available.
		/// </summary>
		public readonly EventAccessor<TextInputEventHandler> TextInput { get; } = new .() ~ delete _;

		/// <summary>
		/// Occurs when text is being edited.
		/// </summary>
		public readonly EventAccessor<TextInputEventHandler> TextEditing { get; } = new .() ~ delete _;
